...
For more information on deleting abandoned resources read the [Crossplane troubleshooting guide]({{<ref "/v1.15/guides/troubleshoot#deleting-when-a-resource-hangs" >}}).
{{< /hint >}}
...
[external secret stores](https://docs.crossplane.io/v1.15/guides/vault-as-secret-store/#enable-external-secret-stores-in-the-provider)
for a Provider.
