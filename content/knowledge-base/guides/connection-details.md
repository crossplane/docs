...
* Defining the `writeConnectionSecretToRef` value in the [Composition]({{<ref "/master/concepts/compositions#save-connection-details-to-a-namespace">}}).
* Define the list of secret keys with `connectionDetails` in the
...
secret object containing their connection details. Crossplane also generates
another secret object for each composite resource, 
containing the secrets from all the defined resources.

For example, a Composition defines a single 
{{<hover label="comp1" line="9">}}AccessKey{{</hover>}}
object.  
The {{<hover label="comp1" line="9">}}AccessKey{{</hover>}} writes the
connection secrets to the namespace
{{<hover label="comp1" line="14">}}docs{{</hover>}} in a secret object named
{{<hover label="comp1" line="15">}}key1{{</hover>}}

Crossplane also creates a secret object saved in the namespace
{{<hover label="comp1" line="4">}}other-namespace{{</hover>}}.
...
After applying a Claim, view the Kubernetes secrets to see the two secret objects
created. 

The secret 
{{<hover label="compGetSec" line="3">}}key1{{</hover>}} is from the individual
composed resource.  
Crossplane created the second secret in the namespace 
{{<hover label="compGetSec" line="4">}}other-namespace{{</hover>}} for all
the generated secrets.

```shell {label="compGetSec",copy-lines="1"}
kubectl get secrets -A
NAMESPACE           NAME                                   TYPE                                DATA   AGE
docs                key1                                   connection.crossplane.io/v1alpha1   4      4s
...
The Composition must list the connection secrets to store. Use the 
{{<hover label="comp2" line="16">}}connectionDetails{{</hover>}} object under
the resource and define the keys.  
The {{<hover label="comp2" line="16">}}connectionDetails{{</hover>}} object
contains a list of secret keys, generated by the resource, that Crossplane
should store. 

{{<hint "warning">}}
You can't change the 
{{<hover label="comp2" line="16">}}connectionDetails{{</hover>}} 
of a Composition. You must delete and
...
If resources produce conflicting keys, create a unique name with a
{{<hover label="comp2" line="15">}}name{{</hover>}}.
...
By default an XRD writes all secret keys from the resources to the combined
secret object.
...
XRD defined {{<hover label="xrd" line="4">}}connectionSecretKeys{{</hover>}} 
fields. 
